...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div  class="jumbotron">
        <div class="container">
            <h1 class="jumbotron-heading">Gerenciar Anúncios</h1>
            <p class="lead text-muted" runat="server" id="Enunciado">
                Olá anunciante!
            </p>
        </div>
    </div>
    <a class="btn btn-success text-left" href="Criar_Anuncio.aspx" role="button">Criar um Novo Anúncio</a><br />
    <br />
    <div class="card-columns">
        <div class="card">
            <div class="card-body">
                ...
                <p>Total de propostas Enviadas (aguardando resposta): <asp:Label ID="lblEnviados" runat="server" Text="0" Font-Size="Large" ForeColor="#42c5f5"></asp:Label></p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>Total de propostas Aceitas: <asp:Label ID="lblAceitos" runat="server" Text="0" Font-Size="Large" ForeColor="#28a745"></asp:Label></p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p>Total de propostas Recusadas: <asp:Label ID="lblRecusados" runat="server" Text="0" Font-Size="Large" ForeColor="#ff6363"></asp:Label></p>
