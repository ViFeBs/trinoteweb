...
public partial class PropRecusadas : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dAdapter.Fill(dt);
        for (int i = 0; i < Convert.ToInt32(dt.Tables[0].DefaultView[0].Row["Recusadas"]); i++)
        {
            c.command.CommandText = "select titulo,link,descricao,imagem from Anuncio where Anunciante_idAnunciante = @cod and validacao = 2";
